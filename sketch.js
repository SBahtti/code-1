...
function setup() {
  ...
  player2 = createSprite(280,380);
  player2.addAnimation("runright",player1Img)
  player2.addAnimation("runleft",player2Img)
  player2.scale=0.4
  player2.visible=false
  player2.setCollider("rectangle",0,0,200,300)

  player3 = createSprite(150,380);
  player3.addAnimation("runright",player1Img)
  player3.addAnimation("runleft",player2Img)
  player3.scale=0.4
  player3.visible=false
  player3.setCollider("rectangle",0,0,200,300)
...
function draw() {
  ...
  if (gameState==="LEVEL1"){
   ...
   if(score==100){
    ...
    if(player2.x>=520){
      player2.changeAnimation("runleft")
      player2.velocityX= -5;
      }
    if(player2.x<=260){
    ...
    if(player3.x>=660){
      player3.changeAnimation("runleft")
      player3.velocityX= -5;
      }
    if(player3.x<=150){
      player3.changeAnimation("runright")
      player3.velocityX= 5;
      }
